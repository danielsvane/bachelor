...
The free domain $a^*$ in \fref{strand_displacement_simple} is known as a toehold \cite{Zhang}. The toehold serves the purpose of catalyzing the reaction by giving the strand $ab$ a place to initialize displacement. The displacement reaction speed has been shown to be expontentially related to the toehold sequence length.
